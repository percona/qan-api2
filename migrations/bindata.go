...
func _12_pg_stat_monitor_09_topqueryDownSqlBytes() ([]byte, error) {
	return bindataRead(
		__12_pg_stat_monitor_09_topqueryDownSql,
		"12_pg_stat_monitor_09_topquery.down.sql",
	)
}

func _12_pg_stat_monitor_09_topqueryDownSql() (*asset, error) {
	bytes, err := _12_pg_stat_monitor_09_topqueryDownSqlBytes()
	if err != nil {
		return nil, err
	}
...
func _12_pg_stat_monitor_09_topqueryUpSqlBytes() ([]byte, error) {
	return bindataRead(
		__12_pg_stat_monitor_09_topqueryUpSql,
		"12_pg_stat_monitor_09_topquery.up.sql",
	)
}

func _12_pg_stat_monitor_09_topqueryUpSql() (*asset, error) {
	bytes, err := _12_pg_stat_monitor_09_topqueryUpSqlBytes()
	if err != nil {
		return nil, err
	}
...
var __13_pg_stat_monitor_09_queryplanDownSql = []byte("")

func _13_pg_stat_monitor_09_queryplanDownSqlBytes() ([]byte, error) {
	return bindataRead(
		__13_pg_stat_monitor_09_queryplanDownSql,
		"13_pg_stat_monitor_09_queryplan.down.sql",
	)
}

func _13_pg_stat_monitor_09_queryplanDownSql() (*asset, error) {
	bytes, err := _13_pg_stat_monitor_09_queryplanDownSqlBytes()
	if err != nil {
		return nil, err
	}

	info := bindataFileInfo{name: "13_pg_stat_monitor_09_queryplan.down.sql", size: 0, mode: os.FileMode(0), modTime: time.Unix(0, 0)}
...
var __13_pg_stat_monitor_09_queryplanUpSql = []byte("")

func _13_pg_stat_monitor_09_queryplanUpSqlBytes() ([]byte, error) {
	return bindataRead(
		__13_pg_stat_monitor_09_queryplanUpSql,
		"13_pg_stat_monitor_09_queryplan.up.sql",
	)
}

func _13_pg_stat_monitor_09_queryplanUpSql() (*asset, error) {
	bytes, err := _13_pg_stat_monitor_09_queryplanUpSqlBytes()
	if err != nil {
		return nil, err
	}

	info := bindataFileInfo{name: "13_pg_stat_monitor_09_queryplan.up.sql", size: 0, mode: os.FileMode(0), modTime: time.Unix(0, 0)}
...
var _bindata = map[string]func() (*asset, error){
	...
	"12_pg_stat_monitor_09_topquery.down.sql":     _12_pg_stat_monitor_09_topqueryDownSql,
...
var _bintree = &bintree{nil, map[string]*bintree{
	...
	"12_pg_stat_monitor_09_topquery.down.sql":     {_12_pg_stat_monitor_09_topqueryDownSql, map[string]*bintree{}},
